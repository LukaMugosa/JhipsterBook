...
import me.amplitudo.store.domain.Shipment;
import me.amplitudo.store.service.ShipmentService;
...
/**
 * REST controller for managing {@link me.amplitudo.store.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
