...
import me.amplitudo.store.domain.ProductCategory;
import me.amplitudo.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link me.amplitudo.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
